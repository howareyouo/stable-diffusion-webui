...
options_templates.update(options_section(('extra_networks', "Extra Networks", "sd"), {
    ...
    "extra_networks_card_order_field": OptionInfo("Default", "Default order field for Extra Networks cards", gr.Dropdown, {"choices": ['Default', 'Path', 'Name', 'Created', 'Modified']}).needs_reload_ui(),
