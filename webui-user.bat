...
set COMMANDLINE_ARGS=--skip-version-check --skip-prepare-environment --disable-nan-check --disable-safe-unpickle --opt-split-attention --opt-sub-quad-attention --no-half-vae --opt-channelslast --xformers
